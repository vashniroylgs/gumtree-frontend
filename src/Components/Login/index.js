        ...
        <div className="login-box" id="sectionBox">
          ...
          <div className="logo-container">
            ...
            <div className="login-user-container">
              <input type="text" className="login-input" placeholder="Email" value ={username} name="username" required onChange={this.onChangeText} />
              <p className="blur">{userBlur}</p>
            </div>
            <div className="login-user-container">
              <input type="password" className="login-input" placeholder="Password" value={password} name="password" onChange={this.onChangeText} required />
              <p className="blur">{passwordBlur}</p>
            </div>
            {username!=="" && password!=="" ?<Link to="/" style={{textDecoration:"none"}}><input type="submit" className="login-button" value="Login" id="loginbutton" /></Link>: <input type="submit" className="login-button" value="Login" id="loginbutton" />}
